...
export default function FlightsList(): ReactElement {
    ...
    */
    const [flights, setFlights] = useState<Array<Flight>>(new Array<Flight>(
        ...
        new Flight(1, "zimbabwe", "kenia", new Date(2022, 10, 7, 3, 30, 0, 0), new Array<string>("100 montaditos"), false, 300),
        new Flight(1, "china", "mars", new Date(2022, 10, 7, 3, 30, 0, 0), new Array<string>("100 montaditos"), false, 300),
        new Flight(1, "ok", "xd", new Date(2022, 10, 7, 3, 30, 0, 0), new Array<string>("100 montaditos"), false, 700)
    ));
