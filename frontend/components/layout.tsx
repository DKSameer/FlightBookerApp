...
export default function Layout({children}: any): ReactElement {
  return (
      <div id="app_wrapper" className="flex flex-col justify-center items-center bg-sky-200 h-full overflow-x-hidden border rounded border-sky-300 mx-20 my-10 shadow-md shadow-slate-600">
