...
export default function Layout({children}: any): ReactElement {
  return (
      <div id="app_wrapper" className="flex flex-col justify-center items-center bg-sky-200 h-full border rounded border-sky-300 mx-20 my-10 p-4 shadow-md shadow-slate-800">
